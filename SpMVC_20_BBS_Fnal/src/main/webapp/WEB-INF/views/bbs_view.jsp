...
<head>
	...
	$(function(){
		...
		$(document).no("click",".cmt-item",function() {
			let id = $(this).data("id")
			alert("cmt-item: " + id)
		})
		...
		$(document).on("click","cmt-item-del",function(event) {
			...
			// $(this).closest("div") : 가장 가까운 div를 찾아라
			// $(this).parent("div") : 현재 자신을 감싸고 있는 div를 찾아라
		...
		$("button").click(function(){
			...
			if(txt == '수정') {
				...
				/*
				ajax를 사용해서 form에 담긴 데이터를 controller 전송
				*/
